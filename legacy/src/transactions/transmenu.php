...
<TR>
<TD WIDTH=33%><A HREF="transactions">
<!--<IMG SRC="/images/football.jpg" BORDER=0>-->Recent Transactions</A>
</TD>

<TD WIDTH=34%><A HREF="transactions?year=<?php print $theYear; ?>&month=12">
<!--<IMG SRC="/images/football.jpg" BORDER=0>-->December Transactions</A>
</TD>

<TD WIDTH=33%><A HREF="transactions?year=<?php print $theYear; ?>&month=11">
...
<TR>
<TD WIDTH=33%><A HREF="transactions?year=<?php print $theYear; ?>&month=10">
<!--<IMG SRC="/images/football.jpg" BORDER=0>-->October Transactions</A>
</TD>

<TD WIDTH=34%><A HREF="transactions?year=<?php print $theYear; ?>&month=9">
<!--<IMG SRC="/images/football.jpg" BORDER=0>-->September Transactions</A>
</TD>

<TD WIDTH=34%><A HREF="transactions?year=<?php print $theYear; ?>&month=8">
