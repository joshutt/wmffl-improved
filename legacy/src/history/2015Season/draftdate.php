...
The default date for the draft is August 29th.  As always we check to see if
...
if ($isin) {
    ...
    $thequery .= "FROM draftdate d, user u WHERE d.userid=u.userid and u.username='$user' AND d.date BETWEEN '2015-07-01' AND '2015-10-01' ORDER BY d.date";
