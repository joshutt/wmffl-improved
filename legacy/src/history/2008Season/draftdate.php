...
when you can NOT make the draft.  The date will be announced on or about July 14.</P>
...
if ($isin) {
    ...
    $thequery .= "FROM draftdate d, user u WHERE d.userid=u.userid and u.username='$user' AND d.date BETWEEN '2008-07-01' AND '2008-10-01' ORDER BY d.date";
