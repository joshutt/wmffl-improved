...
$sql .= "WHERE d.season=2010 and d.teamid=t.teamid ";
$sql .= "ORDER BY Round, Pick";

$title = "2010 WMFFL Draft Order";
?>
<? include "base/menu.php"; ?>

<H1 Align=Center>Draft Order</H1>
<H5 ALIGN=Center><I>August 22, 2010</I></H5>
<HR size = "1">
<P>
This is the offical draft order for the 2010 Draft to be held at Joel and Ann-Marie's home
on August 29 at 3:00.  Also remember that your protections are due by Tuesday,
August 24.  The order was determined based on reverse order of finish last season.
</P>
