...
The default date for the draft is August 25th.  As always we check to see if
...
The date will be announced on or about July 20th.</p>
...
if ($isin) {
    ...
    $thequery .= "FROM draftdate d, user u WHERE d.userid=u.userid and u.username='$user' AND d.date BETWEEN '2012-07-01' AND '2012-10-01' ORDER BY d.date";
