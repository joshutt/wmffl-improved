...
<span class="ballot">Status: <span class="status">Rejected - 4-6, 1 No Vote</span></span><br/>
...
<b>Sponsor: Richard Lawson</b><br/>
<span class="ballot">Status: <span class="status">Rejected - 2-8, 1 No Vote</span></span><br/>
...
<div class="card m-2 p-2 bg-light">
    ...
    <span class="ballot">Status: <span class="status">Rejected - 1-9, 1 No Vote</span></span><br/>
...
<div class="card m-2 p-2 bg-light">
    <b>Proposal 2019.4 - New Owner of Beavers</b>
    <b>Sponsor: Richard Lawson</b><br/>
    <span class="ballot">Status: <span class="status">Passed 9-0, 1 abstain, 1 no vote</span></span><br/>
    Make Adam Roughley the new owner of the Fightin' Bitin' Beavers.
